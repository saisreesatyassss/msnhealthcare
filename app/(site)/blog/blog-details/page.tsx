...
export const metadata: Metadata = {
  title: "Blog Details Page - Medical Insights",
  description: "This is the Blog details page for medical articles",
  // other metadata
};
            ...
            <div className="md:w-1/2 lg:w-[32%]">
              ...
              <div className="animate_top mb-10 rounded-md border border-stroke bg-white p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
                ...
                <ul>
                  ...
                  <li className="mb-3 transition-all duration-300 last:mb-0 hover:text-primary">
                    <a href="#">Medical Advances</a>
                  </li>
                  <li className="mb-3 transition-all duration-300 last:mb-0 hover:text-primary">
                    <a href="#">Clinical Practice</a>
                  </li>
                </ul>
              </div>
              ...
              <div className="animate_top rounded-md border border-stroke bg-white p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10">
                <div className="mb-10 w-full overflow-hidden ">
                  <div className="relative aspect-[97/60] w-full sm:aspect-[97/44]">
                    <Image
                      src={"/images/blog/blog-01.png"}
                      alt="Latest Advances in Medical Research"
                      fill
                      className="rounded-md object-cover object-center"
                    />
                  </div>
                ...
                <div className="blog-details">
                  <p>
                    Medical research continues to evolve, with groundbreaking
                    discoveries improving treatment options for a wide range of
                    diseases. Researchers are working on new therapies that
                    target specific genetic markers, leading to more
                    personalized care.
                  </p>

                  <p>
                    Recent advances in oncology, for example, have led to more
                    effective cancer treatments with fewer side effects.
                    Immunotherapy, which boosts the body's own immune system to
                    fight cancer, is showing promising results in clinical
                    trials.
                  </p>
                  ...
                  <p>
                    Personalized medicine is a growing field that tailors
                    treatments to individual patients based on their genetic
                    profiles. This approach is particularly beneficial in
                    treating conditions like cancer, where each patient's
                    disease can be genetically distinct.
                  </p>
                </div>
