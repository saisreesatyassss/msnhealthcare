    ...
    <>
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          {/* <!-- Footer Bottom --> */}
          <div className="flex flex-col flex-wrap items-center justify-center gap-5  -t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            {/* <motion.div
              variants={{
                hidden: {
                  opacity: 0,
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} MNS Health Care. All rights reserved
              </p>
            </motion.div> 
